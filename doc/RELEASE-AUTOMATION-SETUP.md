...
This document covers the GitHub and npm setup required for the current Mercury release model:
...
Do this for every public package that Mercury publishes.
...
3. add a trusted publisher for the GitHub repository `StreamDemon/mercury`
...
2. revoke any personal automation token that used to publish Mercury
