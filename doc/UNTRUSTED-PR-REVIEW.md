...
This is intentionally separate from the normal Mercury dev image.
...
```sh
review-checkout-pr StreamDemon/mercury 432
cd /work/checkouts/mercuryai-mercury/pr-432
```
...
## Preview the Mercury app from the PR
...
- Mercury's embedded PostgreSQL and local storage stay inside the container home volume via `MERCURY_HOME=/home/reviewer/.mercury-review`.
