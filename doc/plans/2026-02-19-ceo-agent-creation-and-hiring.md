...
- installed adapter list for this Mercury instance
...
## 8. New Skill: `mercury-create-agent`

Create new skill directory:

- `skills/mercury-create-agent/SKILL.md`
- `skills/mercury-create-agent/references/api-reference.md`
...
Also update `skills/mercury/SKILL.md` to reference this skill for hiring workflows.
...
- `mercury-create-agent` skill + docs updates
