...
This note inventories the Mercury issues that point to the same UX class of problem:
...
Pattern: Mercury already has several places where the right fix was "show intent immediately, then reconcile," not "wait for refetch."
