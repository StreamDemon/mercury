...
Eval framework for testing Mercury agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Mercury heartbeat skill:
