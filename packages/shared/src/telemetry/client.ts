...
// TODO: final telemetry endpoint pending. Options under consideration:
// modernmethod.io/mercury/telemetry/ingest, telemetry.modernmethod.io/mercury/ingest, mercury-telemetry.modernmethod.io/ingest.
const DEFAULT_ENDPOINTS = [
  "https://telemetry.TODO.example/ingest",
...
export class TelemetryClient {
  ...
  async flush(): Promise<void> {
    ...
    const app = this.config.app ?? "mercury";
