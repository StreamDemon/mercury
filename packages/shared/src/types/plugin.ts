...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within MercuryPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Mercury host.
 *
...
export interface MercuryPluginManifestV1 {
   ...
   */
  minimumMercuryVersion?: PluginMinimumHostVersion;
