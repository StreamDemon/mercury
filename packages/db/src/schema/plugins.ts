...
import type { PluginCategory, PluginStatus, MercuryPluginManifestV1 } from "@mercuryai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<MercuryPluginManifestV1>().notNull(),
