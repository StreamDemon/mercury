...
const manifest: MercuryPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Mercury plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Mercury",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Mercury domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
