import type { PluginLauncherRegistration } from "@mercuryai/plugin-sdk";

export const PLUGIN_ID = "mercury-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".mercury-kitchen-sink-demo.txt",
} as const;
