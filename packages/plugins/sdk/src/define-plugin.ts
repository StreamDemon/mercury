/**
 * `definePlugin` — the top-level helper for authoring a Mercury plugin.
 *
...
// ---------------------------------------------------------------------------
// MercuryPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface MercuryPlugin {
 ...
 * @returns A sealed `MercuryPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@mercuryai/plugin-sdk";
