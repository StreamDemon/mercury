...
function requireCapability(manifest: MercuryPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the Mercury server runtime.
 */
