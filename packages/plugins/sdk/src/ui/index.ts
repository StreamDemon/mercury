/**
 * `@mercuryai/plugin-sdk/ui` — Mercury plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@mercuryai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@mercuryai/plugin-sdk/ui";
 *
