/**
 * Bundling presets for Mercury plugins.
 *
 ...
 * to match the Mercury plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@mercuryai/plugin-sdk/ui",
    "@mercuryai/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
