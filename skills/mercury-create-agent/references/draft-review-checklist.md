...
- [ ] The first paragraph points at the Mercury skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Mercury execution contract verbatim:
...
- [ ] Adapter config matches this Mercury instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
