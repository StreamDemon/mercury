 ...
 */
import type { CompanyPortabilityManifest } from "@mercuryai/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Mercury](https://modernmethod.io/mercury)");
  lines.push("");
