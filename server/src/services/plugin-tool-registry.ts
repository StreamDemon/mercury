...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@mercuryai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: MercuryPluginManifestV1, pluginDbId?: string): void;
