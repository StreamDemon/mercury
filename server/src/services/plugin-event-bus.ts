/**
 * PluginEventBus — typed in-process event bus for the Mercury plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@mercuryai/shared";
import type { PluginEvent, EventFilter } from "@mercuryai/plugin-sdk";
