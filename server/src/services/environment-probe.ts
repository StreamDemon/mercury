import type { Environment, EnvironmentProbeResult } from "@mercuryai/shared";
import type { Db } from "@mercuryai/db";
import { ensureSshWorkspaceReady } from "@mercuryai/adapter-utils/ssh";
import {
...
export async function probeEnvironment(
  ...
  if (parsed.driver === "local") {
    return {
      ok: true,
      driver: "local",
      summary: "Local environment is available on this Mercury host.",
      details: {
