...
import { models as codexFallbackModels } from "@mercuryai/adapter-codex-local";
import { models as cursorFallbackModels } from "@mercuryai/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@mercuryai/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@mercuryai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.MERCURY_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.MERCURY_OPENCODE_COMMAND = "__mercury_missing_opencode_command__";
