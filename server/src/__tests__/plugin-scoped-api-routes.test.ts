...
import { pluginManifestV1Schema, type MercuryPluginManifestV1 } from "@mercuryai/shared";
...
function manifest(apiRoutes: NonNullable<MercuryPluginManifestV1["apiRoutes"]>): MercuryPluginManifestV1 {
  return {
    id: "mercury.scoped-api-test",
    apiVersion: 1,
    version: "1.0.0",
