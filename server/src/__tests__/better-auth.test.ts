...
const ORIGINAL_INSTANCE_ID = process.env.MERCURY_INSTANCE_ID;

afterEach(() => {
  if (ORIGINAL_INSTANCE_ID === undefined) delete process.env.MERCURY_INSTANCE_ID;
  else process.env.MERCURY_INSTANCE_ID = ORIGINAL_INSTANCE_ID;
});
