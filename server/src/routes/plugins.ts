...
import type { ToolRunContext } from "@mercuryai/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@mercuryai/plugin-sdk";
import {
  assertAuthenticated,
  assertBoard,
...
type PluginUiSlotDeclaration = NonNullable<NonNullable<MercuryPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<MercuryPluginManifestV1["launchers"]>[number];
...
interface PluginInstallRequest {
  /** npm package name (e.g., @mercury/plugin-linear) or local path */
  packageName: string;
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@mercuryai/plugin-hello-world-example",
    pluginKey: "mercury.hello-world-example",
    displayName: "Hello World Widget (Example)",
    description: "Reference UI plugin that adds a simple Hello World widget to the Mercury dashboard.",
    localPath: "packages/plugins/examples/plugin-hello-world-example",
    tag: "example",
  },
  {
    packageName: "@mercuryai/plugin-file-browser-example",
    pluginKey: "mercury-file-browser-example",
  ...
  {
    packageName: "@mercuryai/plugin-kitchen-sink-example",
    pluginKey: "mercury-kitchen-sink-example",
    displayName: "Kitchen Sink (Example)",
    description: "Reference plugin that demonstrates the current Mercury plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
    localPath: "packages/plugins/examples/plugin-kitchen-sink-example",
    tag: "example",
  },
  {
    packageName: "@mercuryai/plugin-orchestration-smoke-example",
    pluginKey: "mercuryai.plugin-orchestration-smoke-example",
...
export function pluginRoutes(
   ...
   *   {
   *     "pluginId": "plg_123",
   *     "pluginKey": "mercury.claude-usage",
