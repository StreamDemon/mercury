...
import type { Agent, CompanySecret, EnvBinding, Project, RoutineVariable } from "@mercuryai/shared";
...
import { createIssue, storybookAgents } from "../fixtures/mercuryData";
...
function Section({
  ...
  return (
    <section className="mercury-story__frame overflow-hidden">
      <div className="border-b border-border px-5 py-4">
        <div className="mercury-story__label">{eyebrow}</div>
...
function StoryShell({ children }: { children: ReactNode }) {
  return (
    <div className="mercury-story">
      <main className="mercury-story__inner space-y-6">{children}</main>
    </div>
  );
}
...
See [the implementation notes](https://github.com/StreamDemon/mercury).`;
...
const adapterSchema: JsonSchemaNode = {
  ...
  properties: {
    ...
    apiKey: {
      ...
      title: "API key",
      format: "secret-ref",
      description: "Stored with the active Mercury secret provider.",
    },
    concurrency: {
      type: "integer",
...
const validAdapterValues = {
  ...
  allowedCommands: ["pnpm --filter @mercuryai/ui typecheck", "pnpm build-storybook"],
...
const routineVariables: RoutineVariable[] = [
  {
    ...
    label: "Repository",
    type: "text",
    defaultValue: "StreamDemon/mercury",
    required: true,
    options: [],
  },
  {
...
const storybookProject: Project = {
  ...
  goals: [{ id: "goal-company", title: "We're building Mercury" }],
  name: "Board UI",
  ...
  codebase: {
    ...
    repoUrl: "https://github.com/StreamDemon/mercury",
    repoRef: "master",
    defaultRef: "master",
    repoName: "mercury",
    localFolder: "/Users/dotta/mercury",
    managedFolder: "mercury",
    effectiveLocalFolder: "/Users/dotta/mercury",
    origin: "local_folder",
  },
  workspaces: [],
...
function FormsEditorsShowcase() {
  return (
    <StoryShell>
      <section className="mercury-story__frame p-6">
        <div className="flex flex-wrap items-start justify-between gap-5">
          <div>
            <div className="mercury-story__label">Forms and editors</div>
            <h1 className="mt-2 text-3xl font-semibold tracking-tight">Mercury form controls under realistic state</h1>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Fixture-backed stories for Mercury form controls, markdown editors, inline editors, schedule controls, runtime-variable dialogs, and selection pickers.",
      },
    },
  },
} satisfies Meta;
