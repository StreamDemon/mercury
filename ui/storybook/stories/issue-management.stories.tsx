...
import type { Issue } from "@mercuryai/shared";
        ...
        <main className="mercury-story__inner space-y-6">
          <section className="mercury-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="mercury-story__label">Issue management</div>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            {[
              ...
              const Icon = item.icon;
              return (
                <Card key={item.label} className="mercury-story__frame shadow-none">
                  <CardHeader>
