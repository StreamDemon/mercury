...
import type { Agent, FeedbackVote, IssueComment } from "@mercuryai/shared";
...
import { storybookAgentMap, storybookAgents } from "../fixtures/mercuryData";
...
const issueChatComments: IssueChatComment[] = [
  ...
  createComment({
    ...
    authorAgentId: codexAgent.id,
    authorUserId: null,
    body: "I kept the existing component contracts and added fixtures with realistic Mercury work: checkout, comments, linked runs, and review feedback.",
...
function ChatCommentsStories() {
  return (
    <div className="mercury-story">
      <main className="mercury-story__inner space-y-6">
        <section className="mercury-story__frame p-6">
          <div className="mercury-story__label">Chat & Comments</div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-muted-foreground">
            ...
            surface. The scenarios use Mercury operational content with mixed authors, system timeline events,
...
export const CommentThreads: Story = {
  render: () => (
    <div className="mercury-story">
      <main className="mercury-story__inner">
        <CommentThreadMatrix />
      </main>
    </div>
  ),
