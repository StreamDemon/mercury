...
import { storybookAgents, storybookIssues } from "../fixtures/mercuryData";
...
const agentManagementAgents: Agent[] = [
  agentWith({
    ...
    adapterConfig: {
      ...
      env: {
        ...
        MERCURY_TRACE: { type: "plain", value: "storybook" },
  ...
  agentWith({
    ...
    adapterConfig: {
      ...
      payloadTemplateJson: JSON.stringify({ channel: "mercury-storybook", priority: "normal" }, null, 2),
      env: {
        ...
        <main className="mercury-story__inner space-y-6">
          <section className="mercury-story__frame p-6">
            <div className="flex flex-wrap items-start justify-between gap-5">
              <div>
                <div className="mercury-story__label">Agent management</div>
...
const meta = {
  ...
  parameters: {
    docs: {
      description: {
        component:
          "Agent management stories cover detail, configuration, icon, action, live-run, and config primitive states using extended Mercury fixtures.",
      },
    },
  },
