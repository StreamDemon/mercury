...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@mercuryai/shared";
import type {
...
import { createIssue } from "../fixtures/mercuryData";
    ...
    <div className="mercury-story">
      <main className="mercury-story__inner space-y-6">
        <section className="mercury-story__frame p-6">
          <div className="mercury-story__label">Language</div>
