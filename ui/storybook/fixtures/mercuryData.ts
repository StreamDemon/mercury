...
const storybookRepoRoot = "~/mercury";
const storybookWorkspaceRoot = `${storybookRepoRoot}/.mercury/workspaces`;
const storybookWorktreeRoot = `${storybookRepoRoot}/.mercury/worktrees`;
...
export const storybookAgents: Agent[] = [
  {
    ...
    status: "running",
    reportsTo: "agent-cto",
    capabilities: "Ships full-stack Mercury product tasks, Storybook coverage, and verification.",
...
export const storybookGoals: Goal[] = [
  {
    ...
    companyId: "company-storybook",
    title: "Build Mercury",
    description: "Make Mercury the control plane operators trust for autonomous AI companies.",
    level: "company",
    status: "active",
    parentId: null,
...
const storybookWorkspaceRuntime = {
  commands: [
    ...
    },
    {
      ...
      name: "UI typecheck",
      kind: "job",
      command: "pnpm --filter @mercuryai/ui typecheck",
      cwd: ".",
    },
  ],
};
  ...
  },
  {
    ...
    runtimeServices: [
      createRuntimeService({
        ...
        cwd: null,
        port: 4173,
        url: "https://mercury-docs-preview.vercel.app",
...
export const storybookExecutionWorkspaces: ExecutionWorkspace[] = [
  {
    ...
    name: "MERC-1641 storybook worktree",
    status: "active",
    cwd: `${storybookWorktreeRoot}/MERC-1641-create-super-detailed-storybooks-for-our-project`,
    repoUrl: "https://github.com/StreamDemon/mercury",
    baseRef: "master",
  ...
  },
  {
    ...
    mode: "isolated_workspace",
    strategyType: "git_worktree",
    name: "MERC-1608 release smoke cleanup",
    status: "cleanup_failed",
    cwd: `${storybookWorktreeRoot}/MERC-1608-release-smoke-cleanup`,
    repoUrl: "https://github.com/StreamDemon/mercury",
    baseRef: "master",
    branchName: "MERC-1608-release-smoke-cleanup",
    providerType: "git_worktree",
    providerRef: null,
    derivedFromExecutionWorkspaceId: null,
...
function createProject(overrides: Partial<Project> = {}): Project {
  ...
  return {
    ...
    codebase: {
      ...
      managedFolder: ".mercury/worktrees/storybook",
...
export const storybookContinuationHandoff: IssueDocument = {
  ...
  body: [
    ...
    "",
    "Important files: `ui/storybook/stories/issue-management.stories.tsx` and `ui/storybook/fixtures/mercuryData.ts`.",
  ].join("\n"),
...
export const storybookEntityNameMap = new Map<string, string>([
  ["issue:issue-storybook-1", "MERC-1641"],
  ["issue:issue-storybook-2", "MERC-1528"],
  ["issue:issue-storybook-3", "MERC-1602"],
  ["issue:issue-storybook-4", "MERC-1668"],
  ["issue:issue-storybook-5", "MERC-1669"],
  ["issue:issue-storybook-6", "MERC-1670"],
  ["issue:issue-storybook-7", "MERC-1591"],
