...
function installStorybookApiFixtures() {
  ...
  const currentWindow = window as typeof window & {
    __mercuryStorybookFetchInstalled?: boolean;
  };
  if (currentWindow.__mercuryStorybookFetchInstalled) return;

  const originalFetch = window.fetch.bind(window);
  currentWindow.__mercuryStorybookFetchInstalled = true;
...
const preview: Preview = {
  ...
  globalTypes: {
    theme: {
      description: "Mercury color mode",
      defaultValue: "dark",
      toolbar: {
        title: "Theme",
        icon: "mirror",
