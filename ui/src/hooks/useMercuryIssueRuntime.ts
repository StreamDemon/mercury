...
export interface MercuryIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface MercuryIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: MercuryIssueRuntimeReassignment;
}

interface UseMercuryIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: MercuryIssueRuntimeSendOptions) => Promise<void>;
...
export function useMercuryIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseMercuryIssueRuntimeOptions) {
