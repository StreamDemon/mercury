...
import type { ExecutionWorkspace, Issue } from "@mercuryai/shared";
...
describe("ProjectWorkspaceSummaryCard", () => {
  ...
  it("uses project workspace routes and omits close controls for project workspaces", () => {
    ...
    const titleLink = container.querySelector("a[href='/projects/mercury-app/workspaces/workspace-1']");
