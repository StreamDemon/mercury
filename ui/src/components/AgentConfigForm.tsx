...
import { AGENT_DEFAULT_MAX_CONCURRENT_RUNS, supportedEnvironmentDriversForAdapter } from "@mercuryai/shared";
...
// Canonical type lives in @mercuryai/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@mercuryai/adapter-utils";
