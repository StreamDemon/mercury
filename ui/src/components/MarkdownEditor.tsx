...
import { buildAgentMentionHref, buildProjectMentionHref, buildUserMentionHref } from "@mercuryai/shared";
  ...
  if (richEditorError) {
    return (
      <div
        ref={containerRef}
        className={cn(
          "relative mercury-mdxeditor-scope",
  ...
  return (
    ...
    >
      <MDXEditor
        ...
        className={cn("mercury-mdxeditor", !bordered && "mercury-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "mercury-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
