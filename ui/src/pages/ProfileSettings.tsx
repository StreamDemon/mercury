...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@mercuryai/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Mercury file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Mercury storage.";
