...
/**
 * Filter .mercury.yaml content so it only includes entries whose
...
function generateReadmeFromSelection(
  ...
  lines.push("");
  lines.push("This is an [Agent Company](https://modernmethod.io/mercury) package.");
  lines.push("");
...
export function CompanyExport() {
  ...
  // Recompute .mercury.yaml and README.md content whenever checked files
