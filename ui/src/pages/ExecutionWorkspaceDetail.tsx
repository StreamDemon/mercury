...
import type { ExecutionWorkspace, Issue, Project, ProjectWorkspace } from "@mercuryai/shared";
...
function ExecutionWorkspaceIssuesList({
  ...
  return (
    <IssuesList
      ...
      viewStateKey="mercury:execution-workspace-issues-view"
...
export function ExecutionWorkspaceDetail() {
  ...
  if (workspaceId && activeTab === null) {
    ...
    try {
      const storedTab = localStorage.getItem(`mercury:execution-workspace-tab:${workspaceId}`);
  ...
  const handleTabChange = (tab: ExecutionWorkspaceTab) => {
    try {
      localStorage.setItem(`mercury:execution-workspace-tab:${workspace.id}`, tab);
    } catch {}
      ...
      <div className="space-y-4 overflow-hidden sm:space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="max-w-2xl text-sm text-muted-foreground">
            Configure the concrete runtime workspace that Mercury reuses for this issue flow.
            ...
            <Card className="rounded-none">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <Field label="Provision command" hint="Runs when Mercury prepares this execution workspace">
                    <Textarea
