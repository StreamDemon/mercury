...
export const DISMISSED_KEY = "mercury:inbox:dismissed";
export const READ_ITEMS_KEY = "mercury:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "mercury:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "mercury:inbox:issue-columns";
export const INBOX_NESTING_KEY = "mercury:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "mercury:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "mercury:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "mercury:inbox:collapsed-groups";
