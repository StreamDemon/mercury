...
describe("issue-reference", () => {
  ...
  it("does not treat GitHub issue URLs as internal Mercury issue links", () => {
    expect(parseIssuePathIdFromPath("https://github.com/StreamDemon/mercury/issues/1778")).toBeNull();
    expect(parseIssueReferenceFromHref("https://github.com/StreamDemon/mercury/issues/1778")).toBeNull();
  });
