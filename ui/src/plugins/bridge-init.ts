 ...
 *
 * This is placed on `globalThis.__mercuryPluginBridge__` and consumed by
...
declare global {
  ...
  var __mercuryPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__mercuryPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__mercuryPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
