...
summary: Set up Mercury for local development
---

Run Mercury locally with zero external dependencies.
...
No Docker or external database required. Mercury uses embedded PostgreSQL automatically.
...
To open Mercury to a private network with login enabled:
