...
Mercury supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Mercury?** Use `local_trusted` (the default)
