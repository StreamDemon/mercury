...
Manage companies within your Mercury instance.
...
Company logo uploads use the normal Mercury attachment size limit.
...
| `logoUrl` | string | Optional Mercury asset content path for the stored logo image |
