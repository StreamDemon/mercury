...
- `MERCURY_APPROVAL_ID` — the resolved approval
- `MERCURY_APPROVAL_STATUS` — `approved` or `rejected`
- `MERCURY_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
